...
INSERT INTO PURCHASE(ITEM,RETURNED) VALUES (1,false),(2,false),(4,false),(3,false),(2,false),(1,false);
...
SELECT  CUSTOMER.NAME AS USER_NAME,ITEM.NAME AS PRODUCT, ITEM.PRICE , PURCHASE.DATE_OF_PURCHASE, PURCHASE.RETURNED 
FROM
	CUSTOMER INNER JOIN PURCHASE ON CUSTOMER.PURCHASE_ID=PURCHASE.ID
